...
public class frmMain extends javax.swing.JFrame {
    ...
    private void btnCustomersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomersActionPerformed
        // When user click this button, open frmCustomers and show the table;
        // Create the statement from Cequal, and use the select statement; // Select everything and create in the table
